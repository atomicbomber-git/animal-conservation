...
@section("main-content")
    <div class="container-fluid">
        ...
        @endif
        <h1> Tambahkan Informasi Baru </h1>
        <hr/>
        <form action="{{ route('information.save') }}" enctype="multipart/form-data" method="POST">

            <div class="form-group">
                <label for="title"> Judul: </label>
                <input value="{{ old("title") }}" class="form-control {{ $errors->has("title") ? "is-invalid" : "" }}" type="text" name="title" id="title">
                @if ($errors->has("title"))
            ...
            <div class="form-group">
                <textarea style="height: 500px" name="content" id="editor">{{ old("content") }}</textarea>
